...
attach(ConcEdomex) #this is for not writing the name of the data frame and the $ ever time

#Sort Conc according to INGCOR, FOLIOVIV, FOLIOHOG
ConcEdomex<- orderBy (~+ing_cor+folioviv+foliohog, data=ConcEdomex) #this give us the households sorted by total income

#Adding the values of the expansion FACTOR. The sum is 34 million, which is the number of households in the country.
tot_hogares<-sum(ConcEdomex$factor,to.data.frame=TRUE)
...
ConcEdomex$tam_dec<-tam_dec

# Creating Deciles of Income 

ConcEdomex$MAXT<-ConcEdomex$ing_cor #vamos a crear en esta base la variable MAXT que es una copia de la columna de ingresos

ConcEdomex<-ConcEdomex[with(ConcEdomex, order(rank(MAXT))),]  #lo que hicimos aqu? fue reordenar la base con respecto a MAXT. Cosa que en realidad, ya estaba.

ConcEdomex$ACUMULA<-cumsum(ConcEdomex$factor) #aqu? creamos una variable de suma acumulada del FACTOR de viviendas.
...
for(i in 1:9)
{
  a1<-ConcEdomex[dim(ConcEdomex[ConcEdomex$ACUMULA<tam_dec*i,])[1]+1,]$factor
  ConcEdomex<-rbind(ConcEdomex[1:(dim(ConcEdomex[ConcEdomex$ACUMULA<tam_dec*i,])[1]+1),],
                     ConcEdomex[(dim(ConcEdomex[ConcEdomex$ACUMULA<tam_dec*i,])[1]+1):dim(ConcEdomex[1])[1],])
  
  b1<-tam_dec*i-ConcEdomex[dim(ConcEdomex[ConcEdomex$ACUMULA<tam_dec*i,])[1],]$ACUMULA
  ConcEdomex[(dim(ConcEdomex[ConcEdomex$ACUMULA<tam_dec*i,])[1]+1),]$factor<-b1
  ConcEdomex[(dim(ConcEdomex[ConcEdomex$ACUMULA<tam_dec*i,])[1]+2),]$factor<-(a1-b1)
}

#aqu? estamos creando otra variable de suma acumulada del n?mero de hogares
ConcEdomex$ACUMULA2<-cumsum(ConcEdomex$factor)
...
ConcEdomex[(ConcEdomex$ACUMULA2<=tam_dec),]$DECIL<-1
...
for(i in 1:9)
{
  ConcEdomex[((ConcEdomex$ACUMULA2>tam_dec*i)&(ConcEdomex$ACUMULA2<=tam_dec*(i+1))),]$DECIL<-(i+1)
}

# a lo que le qued? cero (que es la ?ltima observaci?n), ponle el decil 10
ConcEdomex[ConcEdomex$DECIL%in%"0",]$DECIL<-10

setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex")
write.dbf(ConcEdomex,file="ConcEdomex2010.dbf")
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex")
write.dbf(ConcEdomex,file="ConcEdomex2018.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex")
Conc2010<-read.dbf("ConcEdomex2010.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Edomex por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Edomex por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Edomex por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Edomex por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Edomex por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Edomex INDIGENA por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Edomex INDIGENA por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Edomex INDIGENA por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Edomex INDIGENA por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Edomex INDIGENA por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Edomex NO por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Edomex NO por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Edomex NO por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Edomex NO por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Edomex NO por fuente por DECIL LS 2010.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex")
Conc2018<-read.dbf("ConcEdomex2018.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Edomex Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Edomex Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Edomex Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Edomex Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Edomex Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Edomex INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Edomex INDIGENA Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Edomex INDIGENA Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Edomex INDIGENA Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Edomex INDIGENA Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Edomex NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Edomex NO Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Edomex NO Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Edomex NO Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Edomex NO Ingresos por fuente por DECIL LS 2018.dbf")
...
Deciles2010<-read.dbf("Edomex por fuente por DECIL estimaciones 2010.dbf")
names(Deciles2010)[1]<-c("ingcor2010")

Deciles2018<-read.dbf("Edomex Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010No<-read.dbf("Edomex NO por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010No)[1]<-c("No2010")

deciles2018No<-read.dbf("Edomex NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010indigena<-read.dbf("Edomex INDIGENA por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010indigena)[1]<-c("Indigena2010")

deciles2018indigena<-read.dbf("Edomex INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
setwd(c("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex/Edomex"))

Deciles2010<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex/Edomex/Edomex por fuente por DECIL estimaciones 2010.dbf")
names(Deciles2010)[1]<-c("ingcor2010")

Deciles2018<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex/Edomex/Edomex Ingresos por fuente por DECIL estimaciones 2018.dbf")
names(Deciles2018)[1]<-c("ingcor2018")
...
GIC_Edomex<-GICTotal%>%
  ...
  geom_col()+
  labs(title = "Growth Incidence Curve Edomex 2010-2018",
       y="Growth rate (total)",
       x="Decile")+
...
GIC_Edomex<-ggplotly(GIC_Edomex)

GIC_Edomex

saveWidget(GIC_Edomex,fil="GIC_Edomex_total.html")
...
Deciles_por_fuente_2010<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex/Edomex/Edomex por fuente por DECIL estimaciones 2010.dbf")
...
Deciles_por_fuente_2018<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex/Edomex/Edomex Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010indigena<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex/Edomex/Edomex INDIGENA por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010indigena)[1]<-c("Indigena2010")

deciles2018indigena<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex/Edomex/Edomex INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
names(deciles2018indigena)[1]<-c("Indigena2018")

deciles2010No<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex/Edomex/Edomex NO por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010No)[1]<-c("No2010")

deciles2018No<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex/Edomex/Edomex NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
names(deciles2018No)[1]<-c("No2018")
...
GIC_por_raza<-GIC_por_raza_derretida%>%
  ...
  labs(title = "Growth Incidence Curve Edomex by ethnic group 2010-2018",
       fill="Ethnic group:",
       y="Growth rate (total)",
       x="Decile")+
...
saveWidget(GIC_por_raza,fil="GIC_Edomex_by_ethnic_group.html")
...
Deciles_por_fuente_2010_indigena<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex/Edomex/Edomex INDIGENA por fuente por DECIL estimaciones 2010.dbf")
...
Deciles_por_fuente_2018_indigena<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex/Edomex/Edomex INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
Deciles_por_fuente_2010_NO<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex/Edomex/Edomex NO por fuente por DECIL estimaciones 2010.dbf")
...
Deciles_por_fuente_2018_NO<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex/Edomex/Edomex NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
GIC<-ggplot()+
  ...
  geom_col(data = NO_melt, mapping=aes(x=as.numeric(Deciles)+0.15, y=value, fill= as.factor(variable), group=`Ethnic group`),
           width = 0.25)+
  labs(title = "Edomex, Growth Incidence Curve by ethnic group, 2010-2018",
       y="Growth rate (total)",
       x="Decile",
...
saveWidget(GIC,fil="GIC_Edomex_by_ethnic_group_and_source.html")
