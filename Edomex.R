...
ConcEdomex<- orderBy (~+INGCOR+FOLIOVIV+FOLIOHOG, data=ConcEdomex) #this give us the households sorted by total income
...
ConcEdomex$MAXT<-ConcEdomex$INGCOR #vamos a crear en esta base la variable MAXT que es una copia de la columna de ingresos
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex/Edomex")
write.dbf(ConcEdomex,file="ConcEdomex2008.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex/Edomex")
Conc2008<-read.dbf("ConcEdomex2008.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Edomex por fuente por DECIL estimaciones 2008.dbf")
write.dbf(c_DECIL_SE,file = "Edomex por fuente por DECIL errores standard 2008.dbf")
write.dbf(c_DECIL_CV,file = "Edomex por fuente por DECIL CV 2008.dbf")
write.dbf(c_DECIL_LI,file = "Edomex por fuente por DECIL LI 2008.dbf")
write.dbf(c_DECIL_ES,file = "Edomex por fuente por DECIL LS 2008.dbf")
...
write.dbf(c_DECIL_ES,file = "Edomex INDIGENA por fuente por DECIL estimaciones 2008.dbf")
write.dbf(c_DECIL_SE,file = "Edomex INDIGENA por fuente por DECIL errores standard 2008.dbf")
write.dbf(c_DECIL_CV,file = "Edomex INDIGENA por fuente por DECIL CV 2008.dbf")
write.dbf(c_DECIL_LI,file = "Edomex INDIGENA por fuente por DECIL LI 2008.dbf")
write.dbf(c_DECIL_ES,file = "Edomex INDIGENA por fuente por DECIL LS 2008.dbf")
...
write.dbf(c_DECIL_ES,file = "Edomex NO por fuente por DECIL estimaciones 2008.dbf")
write.dbf(c_DECIL_SE,file = "Edomex NO por fuente por DECIL errores standard 2008.dbf")
write.dbf(c_DECIL_CV,file = "Edomex NO por fuente por DECIL CV 2008.dbf")
write.dbf(c_DECIL_LI,file = "Edomex NO por fuente por DECIL LI 2008.dbf")
write.dbf(c_DECIL_ES,file = "Edomex NO por fuente por DECIL LS 2008.dbf")
...
Deciles2008<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex/Edomex/Edomex por fuente por DECIL estimaciones 2008.dbf")
...
GIC_Edomex<-GICTotal%>%
  ...
  geom_col()+
  labs(title = "Growth Incidence Curve Edomex 2008-2018",
       y="Growth rate (total)",
       x="Decile")+
  theme_minimal()
...
Deciles_por_fuente_2008<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex/Edomex/Edomex por fuente por DECIL estimaciones 2008.dbf")
...
saveWidget(GIC,fil="GIC_Edomex_por_fuente.html")
...
deciles2008indigena<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex/Edomex/Edomex INDIGENA por fuente por DECIL estimaciones 2008.dbf")
...
deciles2008No<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex/Edomex/Edomex NO por fuente por DECIL estimaciones 2008.dbf")
...
GIC_por_raza<-GIC_por_raza_derretida%>%
  ...
  labs(title = "Growth Incidence Curve Edomex by ethnic group 2008-2018",
       fill="Ethnic group:",
       y="Growth rate (total)",
       x="Decile")+
  theme_minimal()
...
saveWidget(GIC_por_raza,fil="GIC_Edomex_por_raza.html")
...
Deciles_por_fuente_2008_indigena<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex/Edomex/Edomex INDIGENA por fuente por DECIL estimaciones 2008.dbf")
...
Deciles_por_fuente_2008_NO<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Edomex/Edomex/Edomex NO por fuente por DECIL estimaciones 2008.dbf")
...
GIC<-ggplot()+
  ...
  geom_col(data = NO_melt, mapping=aes(x=as.numeric(Deciles)+0.15, y=value, fill= as.factor(variable), group=`Ethnic group`),
           width = 0.25)+
  labs(title = "Edomex, Growth Incidence Curve by ethnic group, 2008-2018",
       y="Growth rate (total)",
       x="Decile",
...
saveWidget(GIC,fil="GIC_Edomex_por_raza_por_fuente.html")
